...
<div>
	...
	<tr></tr>
	<tr>
		<th scope="col" class="shot">四投目</th>
	</tr>
	<tr>
		<th scope="col" class="shot">1桁目</th>
		<th scope="col" class="shot">2桁目</th>
	...
	<tr>
		<td class="shot"><s:property value="%{#session.tryFoura}" /></td>
		<td class="shot"><s:property value="%{#session.tryFourb}" /></td>
		<td class="shot"><s:property value="%{#session.tryFourc}" /></td>
		<td class="shot"><s:property value="%{#session.hitCount3}" /></td>
		<td class="shot"><s:property value="%{#session.blowCount3}" /></td>
	</tr>
	</table>


<s:form action="FifthShotAction">
	<table>
		<tr>
		...
		<tr>
			<td class="shot"><select name="tryFivea" >
			...
			<td class="shot"><select name="tryFiveb" >
				<option value="1">1</option>
				<option value="2">2</option>
				<option value="3">3</option>
				<option value="4">4</option>
			...
			<td class="shot"><select name="tryFivec" >
				<option value="1">1</option>
				<option value="2">2</option>
				<option value="3">3</option>
				<option value="4">4</option>
